...
Launches everything needed for the REAL robot to navigate using an existing map:
  ...
  5. map_server               — Serves the saved map (map.yaml)
...
Usage:
  ...
  # With custom map:
  ros2 launch robot_hardware real_robot_nav.launch.py map:=/path/to/map.yaml
...
def generate_launch_description():
    ...
    default_map = os.path.join(pkg_robot_simulation, 'map.yaml')
    ...
    serial_port_arduino = LaunchConfiguration('serial_port_arduino', default='/dev/ttyUSB0')
    serial_port_lidar = LaunchConfiguration('serial_port_lidar', default='/dev/ttyUSB1')
    ...
    # =========================================================================
    # 9. AUTO INITIAL POSE (after 10 seconds — gives nodes time to start)
    # =========================================================================
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('serial_port_arduino', default_value='/dev/ttyUSB0',
                             description='Serial port for Arduino (motors/encoders)'),
        DeclareLaunchArgument('serial_port_lidar', default_value='/dev/ttyUSB1',
